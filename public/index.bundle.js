...
function encapsulateStyles(node) {
	(0, _shared.setAttribute)(node, "svelte-1252558890", "");
}

function add_css() {
	var style = (0, _shared.createElement)("style");
	style.id = 'svelte-1252558890-style';
	style.textContent = "[svelte-1252558890].frow,[svelte-1252558890] .frow{display:flex;flex-flow:row;flex-wrap:wrap;justify-content:flex-start}[svelte-1252558890].fcolumn,[svelte-1252558890] .fcolumn{display:flex;flex-flow:column;margin-right:10px;margin-bottom:10px;z-index:2}[svelte-1252558890].icons,[svelte-1252558890] .icons{display:flex;flex-wrap:wrap;flex-direction:row;margin-bottom:7px;max-width:100px}[svelte-1252558890].icons .icon,[svelte-1252558890] .icons .icon{cursor:pointer;padding-bottom:6px;margin-bottom:11px;margin-right:6px;border-bottom:1px solid #dddddd}[svelte-1252558890].icons .icon.selected,[svelte-1252558890] .icons .icon.selected{opacity:100%;padding-bottom:3px;border-bottom:3px solid #ff6600}[svelte-1252558890].icon div,[svelte-1252558890] .icon div{opacity:0.666;image-rendering:auto}[svelte-1252558890].icon.selected div,[svelte-1252558890] .icon.selected div{opacity:1}[svelte-1252558890].linear_combinations_sprite,[svelte-1252558890] .linear_combinations_sprite{background-image:url('images/linear_combinations.jpg')\n  }[svelte-1252558890]#caption,[svelte-1252558890] #caption{max-width:200px}[svelte-1252558890]#icons-first,[svelte-1252558890] #icons-first{order:1\n  }[svelte-1252558890]#sprite-first,[svelte-1252558890] #sprite-first{order:2\n  }[svelte-1252558890]#sprite-second,[svelte-1252558890] #sprite-second{order:5\n  }[svelte-1252558890]#icons-second,[svelte-1252558890] #icons-second{order:4\n  }[svelte-1252558890].result,[svelte-1252558890] .result{z-index:3}[svelte-1252558890].operator,[svelte-1252558890] .operator{display:none}@media(min-width: 1024px){[svelte-1252558890].fcolumn,[svelte-1252558890] .fcolumn{margin-left:10px}[svelte-1252558890].fcolumn:first-of-type,[svelte-1252558890] .fcolumn:first-of-type{margin-left:0}[svelte-1252558890].fcolumn:last-of-type,[svelte-1252558890] .fcolumn:last-of-type{margin-right:0}[svelte-1252558890]#icons-first,[svelte-1252558890] #icons-first{order:1\n    }[svelte-1252558890]#sprite-first,[svelte-1252558890] #sprite-first{order:2;margin-right:0}[svelte-1252558890]#sprite-second,[svelte-1252558890] #sprite-second{order:4;margin-left:0}[svelte-1252558890]#icons-second,[svelte-1252558890] #icons-second{order:5\n    }[svelte-1252558890].operator,[svelte-1252558890] .operator{display:block;background-image:url(images/join_arrow.svg);background-position:center 70%;background-repeat:no-repeat;background-size:280%;min-width:60px;height:180px;overflow:visible;order:3;opacity:0.33}[svelte-1252558890].result.c,[svelte-1252558890] .result.c{top:-64px;margin-left:240px;position:relative}[svelte-1252558890].result.c > div,[svelte-1252558890] .result.c > div{border:2px solid white;box-shadow:0px 5px 20px hsla(0,0%,0%,0.3)}[svelte-1252558890]#sprite-second > span,[svelte-1252558890] #sprite-second > span{text-align:right}[svelte-1252558890].linear-combinations,[svelte-1252558890] .linear-combinations{margin-bottom:-84px}}";
	(0, _shared.appendNode)(style, document.head);
}
...
function LinearCombinations(options) {
	...
	if (!document.getElementById("svelte-1252558890-style")) add_css();
