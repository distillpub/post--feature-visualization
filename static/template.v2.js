...
var style = "span.katex-display {\n  text-align: left;\n  padding: 8px 0 8px 0;\n  margin: 0.5em 0 0.5em 1em;\n}\n\nspan.katex {\n  -webkit-font-smoothing: antialiased;\n  color: rgba(0, 0, 0, 0.8);\n  font-size: 1.18em;\n}\n";

const styles = base + layout + byline + article + style + print;
...
class DMath extends Mutating(T$2(HTMLElement)) {
...
const T$4 = Template('d-citation-list', `
<style>
...
class CitationList extends T$4(HTMLElement) {
...
class Code extends Mutating(T$5(HTMLElement)) {
...
class Footnote extends T$6(HTMLElement) {
...
const T$7 = Template('d-footnote-list', `
<style>
...
class FootnoteList extends T$7(HTMLElement) {
...
class Title extends T$8(HTMLElement) {
...
class Slider extends T$11(HTMLElement) {
...
const T$12 = Template('distill-header', `
<style>
distill-header {
  position: relative;
  height: 60px;
...
class DistillHeader extends T$12(HTMLElement) {
...
const T$13 = Template('distill-footer', `
<style>
...
class DistillFooter extends T$13(HTMLElement) {
...
const distillMain = function() {
  ...
  const components = [
    ...
    Footnote, FootnoteList, FrontMatter$1, Title, DMath, References, TOC, Figure,
    Slider, Interstitial
  ];
